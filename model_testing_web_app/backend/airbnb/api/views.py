...
def generate_prediction(request, *args, **kargs):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            output_data['location_score'] = rating_score
            output_data['rating_score'] = location_score
